...
| `src/layers/motivation/` | `drivers.js` — the eight drivers, the five continuation rules and the inject they build. `lottery.js` — the per-turn draw, the lock, and the roll recorded on each message. |
